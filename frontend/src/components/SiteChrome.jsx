    ...
    <div className="site-shell" data-testid="site-shell">
      ...
      <header className="site-header" data-testid="site-header">
        ...
        <nav className={`header-nav ${menuOpen ? 'is-open' : ''}`} data-testid="header-navigation">
          ...
          <Link className={location.pathname.startsWith('/usecases') ? 'active' : ''} to="/usecases" onClick={closeMenu} data-testid="header-use-cases-link">Use cases</Link>
          ...
          <a className={location.pathname === '/' && location.hash === '#watch-demo' ? 'active' : ''} href="/#watch-demo" onClick={closeMenu} data-testid="header-demo-link">Watch demo</a>
      ...
      <footer className="site-footer expanded-footer" data-testid="site-footer">
        ...
        <div className="footer-directory" data-testid="footer-links">
          <div><strong>Product</strong><a href="/#capabilities" data-testid="footer-system-link">System</a><Link to="/demo" data-testid="footer-demo-link">Watch demo</Link><Link to="/usecases" data-testid="footer-stories-link">Use cases</Link><button onClick={onJoin} data-testid="footer-access-button">Download the desktop app</button></div>
