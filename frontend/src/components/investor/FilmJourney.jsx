...
import { Seo } from '../Seo';
import { LaptopFilmStage } from './LaptopFilmStage';
...
export const FilmJourney = ({ film, customer = false, onJoin }) => {
  ...
  return <div className={`cinematic-journey cinematic-${film.id}`} data-testid={`${film.id}-destination-page`}>
