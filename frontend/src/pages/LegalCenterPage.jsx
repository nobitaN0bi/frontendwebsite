...
export default function LegalCenterPage() {
  ...
  return (
    <div className="legal-center page-shell" data-testid="legal-center-page">
      ...
      <section className="legal-doc-grid" data-testid="legal-document-grid">
      ...
      <section className="legal-principles section-pad" data-testid="legal-principles">
      ...
      <section className="contact-directory section-pad" data-testid="legal-contact-directory">
