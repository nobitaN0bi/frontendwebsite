  ...
  return (
    <SiteChrome onJoin={() => setWaitlistOpen(true)}>
      <Routes>
        ...
        <Route path="/investor/customer" element={<LegacyCustomerRedirectPage />} />
        ...
        <Route path="/investor/customer/:role/:department/:industry" element={<LegacyCustomerRedirectPage />} />
